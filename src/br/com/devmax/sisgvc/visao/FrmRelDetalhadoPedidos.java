 ...
 * @author Maxwell
 */
public class FrmRelDetalhadoPedidos extends javax.swing.JDialog {

    /**
     * Creates new form FrmRelConsolidadoPedidos
     */
    public FrmRelDetalhadoPedidos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        carregarDados();
    }
    ...
    private void initComponents() {
        ...
        cbStatus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Todos", "Consignado", "Pendente" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRelDetalhadoPedidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmRelDetalhadoPedidos dialog = new FrmRelDetalhadoPedidos(new javax.swing.JFrame(), false);
    ...
    private void gerarRelatorio() {
        ...
        lista = dao.listarDetalhado(cbCidades.getSelectedItem().toString(), cbStatus.getSelectedItem().toString());
        if (lista.size() > 0) {
            try {
                String arquivoJasper = "DetalhadoVendasClientes.jasper";
            ...
            JOptionPane.showMessageDialog(null, "Não há pedidos Consignados ou Pendentes para a localidade: " + cbCidades.getSelectedItem().toString());
        }
